...
# their ``dlt_meta_whl`` config from a v0.0.10 wheel to a v0.1.0
...
#   dlt_meta_whl -> /Volumes/.../databricks_labs_sdp_meta-0.1.0.whl
#
# How ``from src.* import …`` keeps resolving on Phase 2
# ------------------------------------------------------
# The v0.1.0 main wheel BUNDLES a real top-level ``src`` package (plus
...
# v0.1.0 wheel deliberately resolves the legacy namespace through a
