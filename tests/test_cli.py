...
class CliTests(unittest.TestCase):
    ...
    def test_copy_to_uc_volume(self):
        ...
        with patch('os.walk') as mock_walk:
            ...
            with patch('builtins.open', new_callable=MagicMock) as mock_open:
                ...
                dltmeta.copy_to_uc_volume("file:/path/to/src", "/dbfs/path/to/dst")
                self.assertEqual(mock_files_upload.call_count, 3)
                mock_files_upload.assert_any_call(file_path="/dbfs/path/to/dst/src/file1.txt",
                                                  contents=mock_open.return_value, overwrite=True)
                mock_files_upload.assert_any_call(file_path="/dbfs/path/to/dst/src/file2.txt",
                                                  contents=mock_open.return_value, overwrite=True)
                mock_files_upload.assert_any_call(file_path="/dbfs/path/to/dst/src/subdir/file3.txt",
                                                  contents=mock_open.return_value, overwrite=True)
    ...
    def test_get_onboarding_named_parameters(self):
        cmd = OnboardCommand(
            ...
            uc_enabled=True,
            uc_catalog_name="uc_catalog",
            uc_volume_path="/dbfs/mnt/uc_volume",
            overwrite=True,
            bronze_dataflowspec_table="bronze_dataflowspec",
            silver_dataflowspec_table="silver_dataflowspec",
            update_paths=True
        ...
        expected_named_parameters = {
            ...
            "onboarding_file_path": "/dbfs/mnt/uc_volume/dltmeta_conf/onboarding.json",
            "import_author": "Ravi Gawai",
            "version": "1.0",
            "overwrite": "True",
            "env": "dev",
